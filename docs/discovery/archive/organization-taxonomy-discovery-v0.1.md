...
| Location connections       | `[organization-location-connection.ts](../../packages/contracts/src/rpg/vocab/location/connection/organization-location-connection.ts)` | Relationship kinds, not organization classification.                                                                                     |
