...
export const orcLandmarkDefinition = {
  key: 'landmark',
  id: 'orc-landmark',
  label: 'Common Orc landmark names',
  description: 'Landmark names built from orc place roots and landmark suffixes.',
  structures: [
    {
  ...
  partBindings: [
    ...
    {
      partKey: 'placeSuffix',
      collectionId: 'orc-landmark-suffix-pool',
      sourceKey: 'placeSuffix',
    },
  ],
  collectionIds: ['orc-place-root-pool', 'orc-landmark-suffix-pool'],
