...
| `Button`, `buttonVariants`, `ButtonProps`       | component  | Variants include `text` (standalone text actions with optional `tone`); 4 sizes                                                                                             |
| `Link`, `textActionVariants`                    | component  | Inline accent links by default; `context="standalone"` for hover-underline text actions                                                                                     |
