 ...
 * Border, fill, focus, and invalid treatments use semantic `--input-*` tokens.
 */
export const fieldInputShellClasses =
  'rounded-md border border-input bg-input shadow-sm transition-colors'
...
export const fieldInputDisabledClasses = 'disabled:cursor-not-allowed disabled:opacity-50'
