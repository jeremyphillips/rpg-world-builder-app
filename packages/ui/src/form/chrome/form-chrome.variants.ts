...
export const formTabbedAsideBodyClasses =
  'flex h-full min-h-0 min-w-0 flex-col xl:col-start-1 xl:h-full xl:row-start-1'
...
/** Bottom inset for the preview-rail column — 16px breathing room above the viewport edge. */
export const formTabbedAsideSlotBottomInsetClasses = 'xl:pb-4'
...
export const formTabbedAsideSlotClasses = cn(
  'hidden h-full min-h-0 min-w-0 xl:col-start-2 xl:flex xl:h-full xl:flex-col xl:row-start-1',
