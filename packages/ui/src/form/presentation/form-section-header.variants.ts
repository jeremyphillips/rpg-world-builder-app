/** Section heading row when an action sits beside the label stack — action aligns with the heading row. */
export const formSectionHeaderActionLayoutClasses =
  'grid w-full min-w-0 grid-cols-[minmax(0,1fr)_auto] items-start gap-x-4'

export const formSectionHeaderActionSlotClasses = 'shrink-0 justify-self-end'
