...
| Primitives | `src/rpg/primitives/` | Shared value types, semantic mini-packages, catalog-identity admission boundary — placement rules in [docs/structure.md § rpg/primitives/](docs/structure.md#rpgprimitives-organization) |
