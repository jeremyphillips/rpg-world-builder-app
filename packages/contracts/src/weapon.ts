...
import { dieFaceSchema } from './dice'
...
export type WeaponProperty = keyof typeof WEAPON_PROPERTY_LABELS

export const WEAPON_PROPERTIES = Object.keys(WEAPON_PROPERTY_LABELS) as [
  WeaponProperty,
  ...WeaponProperty[],
]
...
export const WEAPON_MASTERY_LABELS = {
  cleave: 'Cleave',
  graze: 'Graze',
  nick: 'Nick',
  push: 'Push',
...
export type WeaponMastery = keyof typeof WEAPON_MASTERY_LABELS

export const WEAPON_MASTERIES = Object.keys(WEAPON_MASTERY_LABELS) as [
  WeaponMastery,
  ...WeaponMastery[],
]
...
export function getWeaponMasteryLabel(m: string): string {
  return WEAPON_MASTERY_LABELS[m as WeaponMastery] ?? m
}
