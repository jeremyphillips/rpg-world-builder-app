...
/** Dashboard SPA invite review — authenticated resolve by invite id. */
export function dashboardCampaignInviteReviewPath(inviteId: string): string {
  return `/app/campaign-invites/${inviteId}`
}
