...
export const BUILDING_FACILITY_TYPE_ENTRIES = {
  ...
  market: {
    ...
    authoringGroups: ['commercial'],
    aliases: ['Marketplace'],
    searchTerms: ['bazaar', 'trade', 'merchants'],
  },
  shop: {
    label: 'Shop',
    description: 'A building configured as a single retail premises for selling goods.',
    defaultFunctions: ['retail'],
    authoringGroups: ['commercial'],
    searchTerms: ['storefront', 'merchant', 'store'],
  },
  bank: {
    label: 'Bank',
  ...
  guildhall: {
    label: 'Guildhall',
    description: 'A building configured for assembly and meetings of a craft or trade community.',
    defaultFunctions: ['assembly'],
    authoringGroups: ['civic'],
    searchTerms: ['guild hall', 'craft hall', 'trade hall'],
  },
  courthouse: {
    label: 'Courthouse',
  ...
  armory: {
    ...
    defaultFunctions: ['storage', 'defense_watch'],
    authoringGroups: ['civic'],
  ...
  archive: {
    label: 'Archive',
    description: 'A building configured for restricted document custody and record preservation.',
    defaultFunctions: ['knowledge'],
    authoringGroups: ['civic'],
