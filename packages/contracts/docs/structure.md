...
| Creature-like runtime primitives (PC, NPC, monster)   | `rpg/runtime/creature/` | `rpg/runtime/creature/languages.ts` — see [runtime-resolution-boundaries.md](runtime-resolution-boundaries.md) |
