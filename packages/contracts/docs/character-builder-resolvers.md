...
| `resolveProficiencyStepModel`                | `resolvers/proficiency/resolve-proficiency-step-model.ts`               | Proficiencies step view model: `fixedGrants` summary rows, interactive `sections`, `hasPendingChoices`, `hasUnresolvedPrerequisites`. Copy helpers live in `format-proficiency-step-copy.ts`.                                                                                                                                               |
