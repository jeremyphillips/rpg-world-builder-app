...
| `deriveRecommendedEquipment`              | `resolvers/equipment/derive-recommended-equipment.ts`                | Recommended equipment ids for the picker Recommended tab (package grants + proficient weapons, armor, and tools).     |
...
| `deriveRecommendedEquipment`              | `resolvers/equipment/derive-recommended-equipment.ts`                | **Implemented** (BENCH-095) — package grants + proficient weapon/armor/tool ids        |
