...
| `resolveSpellcastingProfile`                 | `resolvers/spellcasting/builder-spellcasting.ts`                        | Structural spellcasting facts for the Spells step from class-owned progression; null for non-casters.                                                                                                                                                                                                                                       |
...
| `spellcasting.ts`  | `cantripsKnownAtLevel`, `maxSelectableSpellLevel`                                                                           | `builder-spellcasting.ts`                       |
