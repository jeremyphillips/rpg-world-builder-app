...
| `resolveProficiencyChoicePresentation`       | `resolvers/proficiency/resolve-proficiency-choice-presentation.ts`      | Resolves proficiency block heading + source line from `ChoiceSet.provenance`; also owns pool-description copy and class-first block sort.                                                                                                                                                                                                   |
