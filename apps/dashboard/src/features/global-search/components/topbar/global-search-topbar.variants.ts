...
export const globalSearchTopbarPreviewClasses = cn(
  'absolute top-full right-0 z-50 mt-2 flex max-h-[min(70vh,28rem)] w-[min(100vw-2rem,24rem)] flex-col overflow-hidden rounded-md border border-border bg-surface-subtle shadow-md outline-none',
