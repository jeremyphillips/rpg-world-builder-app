...
import { useVocabularyAvailabilityToggle } from '../hooks/use-vocabulary-availability-toggle'
import { VocabularyAvailabilityBlockedDialog } from './vocabulary-availability-blocked-dialog'
