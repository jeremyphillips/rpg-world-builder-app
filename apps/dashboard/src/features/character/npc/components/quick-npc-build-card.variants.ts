...
export const quickNpcBuildCardSectionClasses = 'flex flex-col gap-y-2'
...
export const quickNpcBuildCardIdentityTitleClasses = 'text-base font-body-emphasis text-foreground'

export const quickNpcBuildCardAttributesShellClasses =
  'flex flex-col rounded-md border border-border'

export const quickNpcBuildCardAttributeRowClasses = 'flex flex-col gap-y-3 px-4 py-3'
