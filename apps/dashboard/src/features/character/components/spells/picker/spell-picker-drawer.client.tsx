...
import { mapSpellPickerCompactSummaryToMetadataLines } from '../../picker/metadata'
...
import { CatalogPickerSelectionSummary } from '../../picker/selection/catalog-picker-selection-summary.client'
