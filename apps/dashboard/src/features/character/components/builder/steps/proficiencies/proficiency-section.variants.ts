...
export const proficiencySectionHeadingRowClasses =
  'mb-1 flex flex-wrap items-baseline gap-x-3 gap-y-1'
...
export const proficiencySectionOverSelectionClasses = 'text-sm text-destructive'

export const proficiencySectionValidationListClasses = 'space-y-1'
