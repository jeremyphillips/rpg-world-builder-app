...
Create/edit forms use [`TabbedForm`](../../../../../packages/ui/docs/forms.md) with tabs: **Basics**, **Proficiencies**, **Spellcasting**, **Features**, and a **Subclasses** stub (links to the detail page on edit). Subclass authoring will replace the stub later.
...
| Subclasses tab stub                  | `components/class-subclasses-tab-stub.tsx` |
