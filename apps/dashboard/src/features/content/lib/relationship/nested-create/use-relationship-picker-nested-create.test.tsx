...
import { useRelationshipPickerNestedCreate } from './use-relationship-picker-nested-create'

const resolveHandoffMock = vi.fn()

vi.mock('../../../organizations/components/create/organization-create-modal', () => ({
...
vi.mock('../../../locations/components/create/location-create-modal', () => ({
  LocationCreateModal: ({
    open,
    createContext,
  }: {
