/** Flex fill participant for TabbedForm / Form inside ViewportWorkspace only. */
export const contentViewportFormFillClasses = 'flex min-h-0 flex-1 flex-col overflow-hidden'
