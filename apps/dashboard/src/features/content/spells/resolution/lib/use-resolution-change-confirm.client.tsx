...
import {
  ...
  type ResolutionChangeDialogCopy,
} from './resolution-selection-context.lib'
import { createDefaultProjectilesFormFields } from './resolution-application-pattern.lib'
...
type ResolutionChangeController = {
...
function useResolutionChangeController(): ResolutionChangeController {
...
function useResolutionChangeSnapshot() {
