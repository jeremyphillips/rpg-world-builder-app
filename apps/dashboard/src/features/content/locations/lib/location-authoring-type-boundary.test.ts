...
const AUTHORING_TYPE_ALLOWED_SUFFIXES = new Set([
  ...
  'location-settlement-create-setup.client.tsx',
  'location-settlement-create-setup.test.tsx',
  'location-region-create-setup.lib.ts',
  'location-region-create-setup.client.tsx',
  'location-site-create-setup.lib.ts',
  'location-site-create-setup.client.tsx',
  'location-create-setup-host.client.tsx',
  ...
  'location-create-modal.client.tsx',
