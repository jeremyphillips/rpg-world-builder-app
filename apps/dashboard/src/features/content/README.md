...
| [`MasterDetailListPanel`](./components/master-detail/master-detail-list-panel.tsx)                            | Bordered collection rail: `listTitle` + Add header, whole-row selection with tint/inset accent, structured meta subtitle (`eyebrow · sourceLabel`), and `No {noun plural} added.` when empty.                                                                                                                                            |
