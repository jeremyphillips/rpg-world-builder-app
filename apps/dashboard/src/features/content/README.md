...
selected row). First consumer: the classes **Features** tab. Species
traits/heritage are the next intended consumers.
...
(e.g. protecting a system class's saved features).
