...
| [`MasterDetailEditorPanel`](./components/master-detail/master-detail-editor-panel.tsx)                        | Bordered detail rail when a row is selected; transparent centered empty state (Sparkles icon + vocab-driven heading/subhead) when nothing is selected. Optional line-3 broad campaign availability + **Change** via `MasterDetailAvailabilityHeaderLine`, overflow delete, validation banner, selected row `FormItems`.                                                                                                                                                                                                                                                                            |
...
| [`MasterDetailEditorShell`](./components/master-detail/master-detail-editor-shell.tsx)                        | Shared bordered detail rail (`self-start`, content-sized): validation banner, identity header (line-3 availability + overflow delete), and body slot or empty state.                                                                                                                                                                                                                                                                                                                                                                                                                               |
